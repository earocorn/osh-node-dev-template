...
/**
 * Configuration settings for the {@link SimulatedSensor} driver exposed via the OpenSensorHub Admin panel.
 * <p>
 ...
 * @since date
 */
public class SimulatedConfig extends SensorConfig {
    ...
    public String serialNumber = "simulated";
}
