 ...
 * @since date
 */
public class PiCameraDescriptor extends JarModuleProvider implements IModuleProvider {
    ...
    public Class<? extends IModule<?>> getModuleClass() {
        ...
        return com.sample.impl.sensor.picamera.PiCameraSensor.class;
    }
